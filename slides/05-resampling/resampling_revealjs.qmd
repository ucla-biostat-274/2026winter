...
- Some methods make a mathematical adjustment to the training error rate in order to estimate the test error rate. These include the $C_p$ statistic, AIC and BIC (ISL Chapter 6 and linear regression lecture notes).
...
<p align="center">
![](./ISL_fig_5_1.png){width=600px height=200px}
</p>
...
<p align="center">
![](./ISL_fig_5_2.png){width=700px height=350px}
</p>
...
<p align="center">
![](ISL_fig_5_5.png){width=600px height=350px}
</p>
...
<p align="center">
![](ISL_fig_5_4.png){width=600px height=300px}
</p>
...
<p align="center">
![](ISL_fig_5_6.png){width=700px height=300px}
</p>

Blue: true test MSE. Black dashed line: LOOCV estimate of test MSE. Orange: 10-fold CV estimate of test MSE. The crosses indicate the minimum of each of the MSE curves. [Left data](https://ucla-biostat-274.github.io/2026winter/slides/02-statlearn/statlearn.html#fig-tradeoff-truth). [Middle data](https://ucla-biostat-274.github.io/2026winter/slides/02-statlearn/statlearn.html#fig-tradeoff-smooth-truth). [Right data](https://ucla-biostat-274.github.io/2026winter/slides/02-statlearn/statlearn.html#fig-tradeoff-wiggly-truth).
...
<p align="center">
![](ISL_fig_5_9.png){width=600px height=600px}
</p>
...
<p align="center">
![](ISL_fig_5_11.png){width=600px height=600px}
</p>
...
<p align="center">
![](ISL_fig_5_10.png){width=500px height=350px}
</p>
