...
<p align="center">
![](ISL_fig_10_13b.pdf){width=600px height=300px}
</p>
...
Seq2seq encoder–decoder comparison. The encoder-decoder model, translating the sentence "she is eating a green apple" to Chinese. The visualization of both encoder and decoder is unrolled in time. Source: Lilian Weng (2018), *Attention? Attention!*.
...
### Soft vs hard attention; global vs local attention
