...
In this example, we used a CNN (convolution neural network) pretrained on the ImageNet database to classify natural images. 
...
```{python}
img_dir = "./slides/11-nn/pretrained_resnet50/book_images"
