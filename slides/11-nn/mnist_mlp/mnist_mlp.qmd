...
Generate predictions on new data:
```{r}
pred <- predict(model, x_test)                 # (n_samples, n_classes)
class_id <- as.array(op_argmax(pred, axis = 2))  # 1-based indices
```
