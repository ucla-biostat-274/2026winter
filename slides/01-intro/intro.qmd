...
subtitle: "Biostat 274, Statistical Learning"
...
### Real Example (1) 
**Development and validation of a bronchoalveolar lavage genomic classifier for acute cellular rejection.** EBioMedicine. 2025 Dec;122:106046. doi: [10.1016/j.ebiom.2025.106046.](https://www.thelancet.com/journals/ebiom/article/PIIS2352-3964(25)00490-6/fulltext)
...
<p align="center">
![](./DP-KF.png){width=750px height=200px} 
</p>

<p align="center">
![](./schema.png){width=400px height=500px}
</p>
...
![](./two_panel_cnn_efficiency_vs_transformer_scale.png){fig-align="center"}
...
![](./ml_timeline.png){fig-align="center"}

- From the 2nd decade of the 21st century, deep learning (LeCun, Bengio, and Hinton, 2025)
- What have changed: 1. massive data; 2. graphics processing units (GPU)
- A petaflop represents $10^{15}$ (a thousand trillion) floating point operations, and a petaflop/s is one petaflop per second.
- One petaflop/s-day represents computation at the rate of a petaflop/s for a period of 24 hours, which is roughly $10^{20}$ floating point operations, and therefore, the top line of the graph represents an impressive $10^{24}$ floating point operations. 
- Green line: “2-year doubling (Moore’s Law)” — what you’d expect if training compute only grew at the pace of typical hardware improvement.
- Red line (modern era): “3.4-month doubling” — shows that since ~2010–2012, the compute used for top systems has been increasing much faster than Moore’s Law (driven by bigger training runs, more GPUs/TPUs, larger datasets/models, etc.).
...
A: No single method dominates. One method may prove useful in answering some questions on a given data set. On a related (not identical) data set or question, another might prevail. [Article](https://arxiv.org/abs/2106.03253), [Article](https://proceedings.neurips.cc/paper_files/paper/2022/file/0378c7692da36807bdec87ab043cdadc-Paper-Datasets_and_Benchmarks.pdf)
:::

## Syllabus

- Read [syllabus](https://ucla-biostat-274.github.io/2026winter/syllabus/syllabus.html) and [schedule](https://ucla-biostat-274.github.io/2026winter/schedule/schedule.html) for a tentative list of topics and course logistics.
